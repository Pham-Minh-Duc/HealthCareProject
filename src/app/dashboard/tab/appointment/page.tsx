    ...
    <div className="w-full h-screen">
        ...
        <div className="flex">
          <div className="grid grid-cols-2 gap-y-3 gap-x-10">
            <div className="flex items-center">
              <label className="w-[100px] text-sm mb-2 mr-2">Giờ Khám</label>
              <input type="text" placeholder="Nhập tên bệnh nhân" className="bg-white"/>
            </div>
            <div className="flex items-center">
              <label className="w-[100px] text-sm mb-2 mr-2">Bác sĩ phụ trách</label>
          ...
          <div className="ml-10">
            <div className="">
              <label className="w-[100px] text-sm mb-2 mr-2">Trạng thái</label>
              <select
                value={status}
      ...
      <div className="mt-5 ml-[26px] mr-[26px] mb-3">
        <div className="bg-white rounded-lg shadow-sm overflow-y-auto mt-5">
          <p className="p-2 text-lg mb-3">📊 Danh sách <span className="font-bold">lịch khám</span></p>
            ...
            <table className="w-full text-sm">
              <thead className="sticky top-0 bg-gray-100 text-left">
                <tr className="text-center">
                  ...
                  <th className="p-3">Ghi chú/ lí do khám</th>
                </tr>
              </thead>
              <tbody>
